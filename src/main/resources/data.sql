...
SELECT 'G' WHERE NOT EXISTS (SELECT 1 FROM mpa WHERE rating = 'G');

INSERT INTO mpa (rating)
SELECT 'PG' WHERE NOT EXISTS (SELECT 1 FROM mpa WHERE rating = 'PG');

INSERT INTO mpa (rating)
SELECT 'PG-13' WHERE NOT EXISTS (SELECT 1 FROM mpa WHERE rating = 'PG-13');

INSERT INTO mpa (rating)
SELECT 'R' WHERE NOT EXISTS (SELECT 1 FROM mpa WHERE rating = 'R');

INSERT INTO mpa (rating)
SELECT 'NC-17' WHERE NOT EXISTS (SELECT 1 FROM mpa WHERE rating = 'NC-17');
